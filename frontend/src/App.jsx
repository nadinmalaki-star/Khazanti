        ...
        {showPrivacyModal && (
          <div style={{ position: "fixed", top: 0, left: 0, right: 0, bottom: 0, background: "rgba(0,0,0,0.75)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 1000 }}>
            <div style={{ background: "#16302d", border: "1px solid #D4AF37", padding: "30px", borderRadius: "16px", width: "90%", maxWidth: "500px", color: "#f2ede2", maxHeight: "80vh", overflowY: "auto" }}>
              ...
              <p style={{ fontSize: "13px", lineHeight: "1.7", opacity: 0.9, marginBottom: "10px" }}>
                بياناتك المالية ملكك إنت، وإنت صاحب-ة القرار فيها.
              </p>
              <p style={{ fontSize: "13px", lineHeight: "1.7", opacity: 0.9, marginBottom: "10px" }}>
                خزنتي بتخزّن بياناتك وبتعرضها إلك عشان تساعدك تدير أموالك وتتابعها، لكنها ما بتمتلك بياناتك.
              </p>
              <p style={{ fontSize: "13px", lineHeight: "1.7", opacity: 0.9, marginBottom: "10px" }}>
                من حسابك، فيك بأي وقت تصدّر-ي بياناتك المالية باستخدام خيار «تصدير Excel»، أو تمسح-ي بياناتك المالية من إعدادات حسابك، حسب الخيارات المتاحة في المنصة.
              </p>
              <p style={{ fontSize: "13px", lineHeight: "1.7", opacity: 0.9, marginBottom: "18px" }}>
