        ...
        {showPrivacyModal && (
          <div style={{ position: "fixed", top: 0, left: 0, right: 0, bottom: 0, background: "rgba(0,0,0,0.75)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 1000 }}>
            <div style={{ background: "#16302d", border: "1px solid #D4AF37", padding: "30px", borderRadius: "16px", width: "90%", maxWidth: "500px", color: "#f2ede2", maxHeight: "80vh", overflowY: "auto" }}>
              ...
              <p style={{ fontSize: "13px", lineHeight: "1.7", opacity: 0.9, marginBottom: "10px" }}>
                بياناتك المالية تخصك، وإنت صاحب-ة القرار فيها.
              </p>
              <p style={{ fontSize: "13px", lineHeight: "1.7", opacity: 0.9, marginBottom: "10px" }}>
              ...
              <p style={{ fontSize: "13px", lineHeight: "1.7", opacity: 0.9, marginBottom: "10px" }}>
                من حسابك، فيك بأي وقت تصدّر-ي حركاتك المالية باستخدام خيار «تصدير Excel»، أو تحذف-ي بياناتك المالية من إعدادات حسابك، حسب الخيارات المتاحة في المنصة.
              </p>
              <p style={{ fontSize: "13px", lineHeight: "1.7", opacity: 0.9, marginBottom: "18px" }}>
              ...
              <p style={{ fontSize: "13px", lineHeight: "1.7", opacity: 0.9, marginBottom: "10px" }}>
                أنت مسؤول-ة عن صحة البيانات التي تدخلها وعن الحفاظ على سرية بيانات تسجيل الدخول الخاصة بحسابك.
              </p>
              <p style={{ fontSize: "13px", lineHeight: "1.7", opacity: 0.9, marginBottom: "18px" }}>
              ...
              <p style={{ fontSize: "13px", lineHeight: "1.7", opacity: 0.9 }}>
                باستخدام منصة خزنتي، فإنك توافق-ي على هذه السياسة وعلى استخدام المنصة وفقًا للشروط الموضحة فيها.
              </p>
